...
export function TaskReview({
  ...
  async function addTask() {
    ...
    if (!title) return
    // The server stamps this as self-tiered: you picked the tier, so there is no
    // suggestion to override, and recording your own pick as Claude's would make
    // the override log quietly useless.
    await run(() => api.addOwnTask(userId, date, title, newTier, tasks.length))
    setNewTitle('')
  }
